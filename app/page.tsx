...
function ExperienceTree() {
  return (
    <div className="flex flex-col justify-center items-start w-full py-4 px-2 pb-0">
      {
        Object.entries(experienceTree).map(([key, value]) => (
          <div key={key} className="flex flex-row items-start last:overflow-y-hidden last:max-h-48">
...
const techToIcon: Record<string, React.ReactNode> = {
  ...
  "Tailwind CSS": <p className="text-2xs">Looking for svg...</p>,
  ...
  "MongoDB": <p className="text-2xs">Looking for svg...</p>,
